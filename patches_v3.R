# Almost there.
# In this version, the inner is chosen at random whilst generating the plot.
# I added a for loop to create 10 distinct plots with a randomly chosen inner.
# Mid and outer do not change.
# The end result is exported as a gif (some people pronounce it gif).
...
for (i in 1:10) {
  #random_inner <- sample(c('inner1', 'inner2', 'inner3', 'inner4', 'inner5'), 1)
